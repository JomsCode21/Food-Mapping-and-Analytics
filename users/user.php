...
<div class="grid grid-cols-4 gap-4">
  <a href="categories.html?cat=restaurants" class="text-center transform transition-transform duration-300 hover:scale-150">
  ...
  <a href="categories.html?cat=fastfoods" class="text-center transform transition-transform duration-300 hover:scale-150">
    <div class="w-16 h-16 mx-auto rounded-full overflow-hidden bg-gray-100 mb-2">
  ...
  <a href="categories.html?cat=cafes" class="text-center transform transition-transform duration-300 hover:scale-150">
    <div class="w-16 h-16 mx-auto rounded-full overflow-hidden bg-gray-100 mb-2">
  ...
  <a href="categories.html?cat=bakery" class="text-center transform transition-transform duration-300 hover:scale-150">
    <div class="w-16 h-16 mx-auto rounded-full overflow-hidden bg-gray-100 mb-2">
    ...
    <section class="p-6">
        ...
        <div class="mb-6 bg-gray-300 h-64">
           
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d124061.10759452378!2d122.90189315577693!3d13.663259827099685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a21886a19dfc3f%3A0x91fb88e544c926cc!2sLibmanan%2C%20Camarines%20Sur!5e0!3m2!1sen!2sph!4v1745640028294!5m2!1sen!2sph" 
                width="100%" 
                height="180%" 
                style="border:0;" 
                allowfullscreen="" 
