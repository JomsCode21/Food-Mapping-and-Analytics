(function () {
  ...
  function currentTheme() {
    ...
    return root.classList.contains('theme-dark') || root.classList.contains('dark') ? 'dark' : 'light';
  }
  ...
  function createFloatingToggleIfMissing() {
    ...
    button.innerHTML = '<span class="theme-toggle-glyph" data-theme-glyph aria-hidden="true">\u263E</span>';
