          ...
          <div class="container mx-auto px-4">  <!-- Center the content -->
            <div class="hero-text">
              ...
              <div class="mt-6 space-x-3">
                ...
                <button id="registerBusinessBtn" class="bg-primary text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 hover:bg-white hover:text-primary border border-primary" type="button">
...
<div id="login-modal" class="login-modal">
    <div class="modal-content p-5">
        <div class="flex justify-between items-center mb-4">
            ...
            <button class="close-modal w-8 h-8 flex items-center justify-center cursor-pointer">
        ...
        <form id="login-form">
            ...
            <div class="mb-4 relative">
                ...
                <input type="password" id="login-password"
                  ...
                  required />
                  <span id="toggle-password-visibility" class="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer text-gray-500 mt-3 text-2xl" >
            ...
            <div id="login-error-message" class="text-red-600 text-sm mb-2 text-center"></div>
            <button type="submit"
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="#" id="switch-to-register" class="text-primary">Create Account</a>
                </p>
            </div>
        </form>
    </div>
...
<div id="forgot-password-modal" class="login-modal hidden fixed inset-0 z-50 bg-black bg-opacity-50 justify-center items-center">
  <div class="modal-content bg-white p-5 rounded-md shadow-md w-full max-w-md">
    <div class="flex justify-between items-center mb-4">
      <h2 class="text-xl font-semibold">Recover Account</h2>
      <button class="close-modal w-8 h-8 flex items-center justify-center cursor-pointer" id="close-forgot-password-modal">
        <i class="ri-close-line ri-lg"></i>
      </button>
    </div>
    ...
    <form id="forgot-password-form">
      <div class="mb-4">
        ...
        <input
          type="text"
          id="forgot-password-email-phone"
    ...
    <div id="forgot-password-message" class="text-center text-sm mt-3 text-red-600"></div>
  </div>
</div>
...
<script>
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <input
              ...
              required
            />
            <span id="toggle-register-password" class="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer text-gray-500 text-xl">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <input
              ...
              required
            />
            <span id="toggle-register-confirm-password" class="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer text-gray-500 text-xl">
          ...
          <div id="register-error-message" class="text-red-600 text-sm mb-2 text-center"></div>
          <button
            type="submit"
            class="w-full bg-primary text-white py-2 rounded-button font-medium cursor-pointer">
            Create Account
  ...
  <div class="modal-content p-5">
    <div class="flex flex-col items-center">
      <div class="w-16 h-16 mx-auto flex items-center justify-center bg-yellow-100 rounded-full text-yellow-500 mb-4">
        <i class="ri-error-warning-line ri-2x"></i>
      </div>
      <h2 class="text-lg font-semibold mb-2 text-center">Create an Account First</h2>
      <p class="text-gray-600 mb-4 text-center">
        You need to create an account before registering your business.
      </p>
      <div class="flex justify-center gap-4 w-full">
        <button id="register-business-warning-ok" class="bg-primary text-white py-2 px-6 rounded-button font-medium">OK</button>
        <button id="register-business-warning-cancel" class="bg-gray-200 text-gray-700 py-2 px-6 rounded-button font-medium">Cancel</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  // Send login data to login_process.php using fetch
    ...
    // Redirect based on user_type after 2 seconds
    setTimeout(() => {
    ...
    // Login failed
    document.getElementById("login-error-message").textContent = data.message || "Incorrect Email or Password.";
  ...
  const registerConfirmPasswordError = document.getElementById("register-email-error"); // We'll create a new error div for confirm password
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (viewDetailsButton && notification) {
