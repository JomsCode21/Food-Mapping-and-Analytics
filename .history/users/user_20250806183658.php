...
<div class="grid grid-cols-4 gap-4">
  ...
  <a href="../fbusinessowner/categories.php?cat=bakery" class="text-center transform transition-transform duration-300 hover:scale-150">
    ...
    <section class="p-6">
      ...
      <div id="libmanan-map" class="mb-6">
...
<footer class="bg-primary text-white mt-10 px-4 py-6">
  ...
  <script>
  function initMap() {
    // Center on Libmanan, Camarines Sur
    ...
    // Example: Add a marker (replace with dynamic data from your PHP/db)
    ...
    // TODO: Fetch your registered businesses from PHP and add markers for each
  }
