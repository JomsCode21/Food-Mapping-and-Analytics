...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    ...
    exit;
     ...
     require_once '../db_con.php';
        ...
        $sql = "SELECT business_name, owner_name, business_type, application_date FROM business_applications WHERE status='$status' ORDER BY application_date DESC";
...
<section class="bg-white rounded-md shadow-md p-4 mb-6" id="registrationTable">  
  ...
  <div class="overflow-x-auto">
    ...
    <tbody id="tableBody">
      ...
      $sql = "SELECT business_name, owner_name, business_type, application_date, user_id
        FROM business_applications WHERE status='$status' ORDER BY application_date DESC";
      $result = $conn->query($sql);
...
<br>
  ...
  <div class="overflow-x-auto">
    <table class="min-w-full leading-normal">
      ...
      FROM accounts
      LEFT JOIN fb_owner ON fb_owner.user_id = accounts.user_id
      WHERE accounts.user_type = 'fb_owner'";
  ...
  options: {
    ...
    scales: {
      ...
      const pieChart = new Chart(document.getElementById("pieChart"), {
        type: "pie",
        data: {
          labels: ["Restaurant", "MilkteaShop", "Fastfood", "Bakery"],
          datasets: [
            {
              data: [40, 30, 20, 10],
