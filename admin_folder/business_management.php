      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="md:col-span-1 bg-white rounded-2xl shadow-sm border border-gray-100 p-0 flex flex-col items-center min-h-[600px]">
          ...
          <ul class="w-full">
            ...
            <li class="mb-2 w-full">
              <a href="business_management.php" class="flex items-center px-6 py-3 rounded-lg transition font-medium text-yellow-700 dark:text-yellow-100 gap-3 bg-yellow-100 dark:bg-yellow-900/30 font-bold">
